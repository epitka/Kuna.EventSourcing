...
namespace Kuna.EventSourcing.Kurrent.Tests.Subscriptions;
...
public class PersistentSubscriptionTests
{
    ...
    public PersistentSubscriptionTests(KurrentDBContainerFixture kurrentDBDatabaseFixture)
    {
